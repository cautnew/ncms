...
export default function Template({ name, description, version }: { name?: string; description?: string; version?: string }) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    ...
                    <div className="space-y-2 rounded-md bg-zinc-300 p-2 dark:bg-zinc-800">
