        ...
        <div class="hidden sm:flex sm:items-center sm:ms-4">
          ...
          <div class="ms-1 relative">
            <Dropdown align="right" width="48">
              ...
              <template #content>
                <DropdownLink v-for="section in menuOptions.getSectionList('account')" :key="section" :href="route(section.route)">
                  {{ section.name }}
                </DropdownLink>
              </template>
            </Dropdown>
      ...
      <div :class="{
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
          ...
          <div class="mt-3 space-y-1">
            <ResponsiveNavLink v-for="section in menuOptions.getSectionList('account')" :key="section" :href="route(section.route)">
              {{ section.name }}
            </ResponsiveNavLink>
          </div>
        </div>
