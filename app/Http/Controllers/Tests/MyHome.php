...
class MyHome extends Controller
{
    ...
    public function index()
    {
        ...
        $counterSection = TAG::section('p-4 text-center fs-1 fw-bold', append: [
            TAG::p(html: 'Restam'),
            TAG::p('mb-1', append: [TAG::span(id: 'time-left-days')]),
            TAG::p('mb-1', append: [TAG::span(id: 'time-left-hours')]),
            TAG::p('mb-1', append: [TAG::span(id: 'time-left-minutes')]),
            TAG::p(append: [TAG::span(id: 'time-left-seconds')]),
            TAG::p(html: 'ou simplesmente'),
            TAG::p(append: [TAG::span(id: 'time-left-in-seconds')]),
        ]);
        ...
        const timeGoal = new Date("December 15, 2025 12:00:00");
        ...
        const tagTimeLeftInSeconds = document.querySelector('#time-left-in-seconds');
        ...
        const funcTimeCounting = () => {
            ...
            tagTimeLeftInSeconds.innerHTML = timeDiffSeconds + " segundos";
        };
